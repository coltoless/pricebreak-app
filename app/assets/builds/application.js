...
var MapPin = createLucideIcon("map-pin", __iconNode8);

// node_modules/lucide-react/dist/esm/icons/minus.js
var __iconNode9 = [["path", { d: "M5 12h14", key: "1ays0h" }]];
var Minus = createLucideIcon("minus", __iconNode9);
...
var Plane = createLucideIcon("plane", __iconNode10);
...
var Save = createLucideIcon("save", __iconNode12);
...
var FlightPriceFilter = ({
  ...
  const [showSummary, setShowSummary] = (0, import_react3.useState)(false);
  const popularRoutes = [
    {
  ...
  const getPriceBreakConfidenceIcon = (confidence) => {
    switch (confidence) {
      case "high":
        return /* @__PURE__ */ import_react3.default.createElement(TrendingDown, { className: "w-4 h-4" });
      case "medium":
        return /* @__PURE__ */ import_react3.default.createElement(Minus, { className: "w-4 h-4" });
      case "low":
        return /* @__PURE__ */ import_react3.default.createElement(TrendingUp, { className: "w-4 h-4" });
      default:
        return /* @__PURE__ */ import_react3.default.createElement(Minus, { className: "w-4 h-4" });
    }
  };
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-lg" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-center mb-8" }, /* @__PURE__ */ import_react3.default.createElement("h1", { className: "text-3xl font-bold text-gray-900 mb-2" }, "Flight Price Monitoring Filter"), /* @__PURE__ */ import_react3.default.createElement("p", { className: "text-gray-600" }, "Set up intelligent flight price alerts with instant price break notifications")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "mb-8" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center justify-between mb-4" }, steps.map((step, index) => {
    const Icon2 = step.icon;
    const isActive = currentStep === step.id;
    const isCompleted = currentStep > step.id;
    return /* @__PURE__ */ import_react3.default.createElement("div", { key: step.id, className: "flex items-center" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: `flex items-center justify-center w-12 h-12 rounded-full border-2 ${isCompleted ? "bg-green-500 border-green-500 text-white" : isActive ? "bg-blue-500 border-blue-500 text-white" : "bg-gray-200 border-gray-300 text-gray-500"}` }, isCompleted ? /* @__PURE__ */ import_react3.default.createElement(Check, { className: "w-6 h-6" }) : /* @__PURE__ */ import_react3.default.createElement(Icon2, { className: "w-6 h-6" })), /* @__PURE__ */ import_react3.default.createElement("div", { className: "ml-3" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: `text-sm font-medium ${isActive ? "text-blue-600" : isCompleted ? "text-green-600" : "text-gray-500"}` }, step.title)), index < steps.length - 1 && /* @__PURE__ */ import_react3.default.createElement("div", { className: `w-16 h-0.5 mx-4 ${isCompleted ? "bg-green-500" : "bg-gray-300"}` }));
  }))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "mb-6 flex flex-wrap gap-4" }, /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
      onClick: () => setShowSummary(!showSummary),
      className: "flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors"
    },
    /* @__PURE__ */ import_react3.default.createElement(Eye, { className: "w-4 h-4 mr-2" }),
    showSummary ? "Hide Summary" : "Show Summary"
  ), /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex gap-2" }, filterTemplates.map((template) => /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
      key: template.id,
    ...
    /* @__PURE__ */ import_react3.default.createElement(Copy, { className: "w-3 h-3 mr-1" }),
    template.name
  )))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "lg:col-span-2" }, currentStep === 1 && /* @__PURE__ */ import_react3.default.createElement(
    Step1RouteDates,
    {
      filter,
      updateFilter,
  ...
  ), currentStep === 2 && /* @__PURE__ */ import_react3.default.createElement(
  ...
  ), currentStep === 3 && /* @__PURE__ */ import_react3.default.createElement(
    Step3PriceSettings,
    {
      filter,
      updateFilter,
  ...
  ), currentStep === 4 && /* @__PURE__ */ import_react3.default.createElement(
  ...
  ), /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex justify-between mt-8" }, /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
      onClick: prevStep,
    ...
    /* @__PURE__ */ import_react3.default.createElement(ArrowLeft, { className: "w-4 h-4 mr-2" }),
    "Previous"
  ), currentStep < 4 ? /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
    ...
    "Next",
    /* @__PURE__ */ import_react3.default.createElement(ArrowRight, { className: "w-4 h-4 ml-2" })
  ) : /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex gap-3" }, /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react3.default.createElement(Play, { className: "w-4 h-4 mr-2" }),
    "Test Alert"
  ), /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react3.default.createElement(Save, { className: "w-4 h-4 mr-2" }),
    "Save Filter"
  )))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "bg-gray-50 p-4 rounded-lg" }, /* @__PURE__ */ import_react3.default.createElement("h3", { className: "font-semibold text-gray-900 mb-3 flex items-center" }, /* @__PURE__ */ import_react3.default.createElement(Star, { className: "w-4 h-4 mr-2" }), "Popular Routes"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "space-y-3" }, popularRoutes.map((route, index) => /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
      key: index,
      onClick: () => {
    ...
    /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex justify-between items-center mb-1" }, /* @__PURE__ */ import_react3.default.createElement("span", { className: "font-medium text-sm" }, route.origin.code, " \u2192 ", route.destination.code), /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-xs text-gray-500" }, route.priceTrend === "falling" ? /* @__PURE__ */ import_react3.default.createElement(TrendingDown, { className: "w-3 h-3 text-green-600" }) : route.priceTrend === "rising" ? /* @__PURE__ */ import_react3.default.createElement(TrendingUp, { className: "w-3 h-3 text-red-600" }) : /* @__PURE__ */ import_react3.default.createElement(Minus, { className: "w-3 h-3 text-gray-400" }))),
    /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-xs text-gray-600" }, "From $", route.bestPrice, " (avg: $", route.averagePrice, ")")
  )))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "bg-gray-50 p-4 rounded-lg" }, /* @__PURE__ */ import_react3.default.createElement("h3", { className: "font-semibold text-gray-900 mb-3 flex items-center" }, /* @__PURE__ */ import_react3.default.createElement(Zap, { className: "w-4 h-4 mr-2" }), "Price Break Examples"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "space-y-3" }, priceBreakExamples.map((example, index) => /* @__PURE__ */ import_react3.default.createElement("div", { key: index, className: "p-3 bg-white rounded-lg border" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "font-medium text-sm mb-1" }, example.title), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-xs text-gray-600 mb-2" }, example.description), /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex justify-between items-center" }, /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-sm font-semibold text-green-600" }, "$", example.price), /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-xs text-gray-500" }, "Save $", example.savings)), example.differences && /* @__PURE__ */ import_react3.default.createElement("div", { className: "mt-2 text-xs text-gray-500" }, example.differences.map((diff, i) => /* @__PURE__ */ import_react3.default.createElement("div", { key: i, className: "flex items-center" }, /* @__PURE__ */ import_react3.default.createElement(TriangleAlert, { className: "w-3 h-3 mr-1 text-yellow-500" }), diff))))))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "bg-blue-50 p-4 rounded-lg" }, /* @__PURE__ */ import_react3.default.createElement("h3", { className: "font-semibold text-blue-900 mb-3" }, "Estimated Results"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-center" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-2xl font-bold text-blue-600 mb-1" }, "24-48"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-sm text-blue-700" }, "flights match your criteria"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-xs text-blue-600 mt-2" }, "Based on current market data"))))), showSummary && /* @__PURE__ */ import_react3.default.createElement("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-6" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex justify-between items-center mb-4" }, /* @__PURE__ */ import_react3.default.createElement("h2", { className: "text-xl font-semibold" }, "Filter Summary"), /* @__PURE__ */ import_react3.default.createElement(
    "button",
    {
    ...
    "\xD7"
  )), /* @__PURE__ */ import_react3.default.createElement(FilterSummary, { filter })))));
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (flightFilterContainer) {
    const root = (0, import_client.createRoot)(flightFilterContainer);
    root.render(
      /* @__PURE__ */ import_react9.default.createElement(
        FlightPriceFilter_default,
        {
          onSaveFilter: (filter) => {
