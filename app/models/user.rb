class User < ApplicationRecord
  ...
  # Associations - Temporarily commented out for Phase 1 testing
  ...
  # Scopes - Temporarily commented out for Phase 1 testing
  ...
  # Methods - Temporarily commented out for Phase 1 testing
  ...
  # def total_savings
  #   flight_alerts.triggered.sum(:price_drop_amount)
  # end

  # def average_savings
  #   triggered_alerts = flight_alerts.triggered
  #   return 0 if triggered_alerts.empty?
    
  #   triggered_alerts.average(:price_drop_amount).round(2)
  # end

  # def filter_performance_summary
  #   total_filters = flight_filters.count
  #   active_filters = flight_filters.active.count
  #   triggered_alerts = flight_alerts.triggered.count
  ...
  #   old_alerts = flight_alerts.where('created_at < 1.month.ago')
